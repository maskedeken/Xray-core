...
const file_proxy_shadowsocks_config_proto_rawDesc = "" +
	"\n" +
	"\x1eproxy/shadowsocks/config.proto\x12\x16xray.proxy.shadowsocks\x1a\x18common/net/network.proto\x1a\x1acommon/protocol/user.proto\x1a!common/protocol/server_spec.proto\"\xbe\x01\n" +
	"\aAccount\x12\x1a\n" +
	"\bpassword\x18\x01 \x01(\tR\bpassword\x12C\n" +
	"\vcipher_type\x18\x02 \x01(\x0e2\".xray.proxy.shadowsocks.CipherTypeR\n" +
	"cipherType\x12\x19\n" +
	"\biv_check\x18\x03 \x01(\bR\aivCheck\x127\n" +
	"\x17reduced_iv_head_entropy\x18\x91\xbf\x05 \x01(\bR\x14reducedIvHeadEntropy\"t\n" +
	"\fServerConfig\x120\n" +
