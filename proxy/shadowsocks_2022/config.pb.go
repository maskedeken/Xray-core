...
const file_proxy_shadowsocks_2022_config_proto_rawDesc = "" +
	...
	"\aAccount\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\"\x8f\x02\n" +
	"\fClientConfig\x125\n" +
	...
	"udpOverTcp\x12/\n" +
	"\x14udp_over_tcp_version\x18\x06 \x01(\rR\x11udpOverTcpVersion\x127\n" +
	"\x17reduced_iv_head_entropy\x18\x91\xbf\x05 \x01(\bR\x14reducedIvHeadEntropyBr\n" +
